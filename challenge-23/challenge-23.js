(function(window, document){
  ...
  */
  ...
  var $visor = document.querySelector('[data-js="tela"]')
  var $numbers = document.querySelectorAll('[data-js="button-number"]')
  var $operations = document.querySelectorAll('[data-js="operations"]')
  var $ce = document.querySelector('[data-js="ce"]')
  var $equal = document.querySelector('[data-js="igual"]')
  ...
  function clickOperations(){
    $visor.value = cleanIfLastItemIsOperation($visor.value)
    $visor.value += this.value
  }

  function isLastItemOperation(number){
    var operations = ['+', '-', '/', '*']
    var lastDigit = number.split('').pop()
  ...
  function cleanIfLastItemIsOperation(number){
  ...
  $equal.addEventListener('click', function(){
    ...
    $visor.value = allValues.reduce(function(accumulated, actual){
      ...
      var lastValue = cleanIfLastItemIsOperation(actual)
