...
*/
  ...
  */
  ...
  var regexJ = /ju[ln]ho/gi
  console.log("Os meses de janeiro, junho e julho começam com a letra j.".match(regexJ))
  ...
  */
  var regexTagVazia = /<[a-z]+><\/[a-z]+>/gi
  console.log('\nMatch com tags HTML vazias (abertura e fechamento da tag):');
  console.log("<div><ul><li></li><li></li><li><span></span></li></ul></div>".match(regexTagVazia))
